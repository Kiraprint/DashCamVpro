 ...
 */
public class SettingsActivity extends com.dashcamvpro.AppCompatPreferenceActivity {
    /**
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            pref.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
                ...
                public boolean onPreferenceClick(Preference preference) {
                    com.dashcamvpro.Util.deleteRecordings();
                    return false;
                }
            });

            Preference prefer = findPreference("use_bt");
            ...
            Preference preference = findPreference("launcher");
            preference.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
                @Override
                public boolean onPreferenceClick(Preference preference) {
                    Context context = getContext();
                    Intent i = new Intent(context, com.dashcamvpro.LaunchActivity.class);
                    i.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
            ...
            Preference preference1 = findPreference("min1");
            preference1.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
                @Override
                public boolean onPreferenceClick(Preference preference) {
                    com.dashcamvpro.Util.MAX_DURATION = 1000*60;
                    Log.d("SA", "MD changed");
                    return false;
                }
            });

            Preference preference2 = findPreference("min5");
            preference2.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
                @Override
                public boolean onPreferenceClick(Preference preference) {
                    com.dashcamvpro.Util.MAX_DURATION = 1000*60*5;
                    Log.d("SA", "MD changed");
                    return false;
                }
            });

            Preference preference3 = findPreference("min30");
            preference3.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
                @Override
                public boolean onPreferenceClick(Preference preference) {
                    com.dashcamvpro.Util.MAX_DURATION = 1000*60*30;
                    Log.d("SA", "MD changed");
                    return false;
                }
            });
            ...
            preference5.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
                ...
                public boolean onPreferenceClick(Preference preference) {
                    ...
                    com.dashcamvpro.Util.QUOTA_WARNING_THRESHOLD = 512*3;
                    Log.d("SA", "MD changed");
                    return false;
                }
            });
