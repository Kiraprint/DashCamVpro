...
import com.dashcamvpro.presenters.IViewRecordings;
import com.dashcamvpro.presenters.ViewRecordingsPresenter;

import java.util.ArrayList;

/**
 * Activity to view video recordings produced by this dash cam application
 * Displays all videos from paths matching %DashCamvpro%
 */
