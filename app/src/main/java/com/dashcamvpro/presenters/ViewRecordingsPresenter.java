package com.dashcamvpro.presenters;
...
import com.dashcamvpro.DBHelper;
import com.dashcamvpro.DashAppV;
import com.dashcamvpro.Util;
...
public class ViewRecordingsPresenter implements IViewRecordings.Presenter {
    ...
    private ArrayList<Recording> getDataSet() {
        return DBHelper.getInstance(DashAppV.getAppContext()).selectAllRecordingsList();
    }
